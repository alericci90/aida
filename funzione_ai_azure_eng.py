...
def bilancio_ai_component_eng(anno_bil, bilancio_data: dict, customer_data: dict):
    ...
    if st.session_state.bilancio_analysis_done:
        st.markdown(
            '<div class="aida-eyebrow">AI Analyst</div>'
            '<div class="aida-sec-title">Initial credit analysis</div>',
    ...
    if st.session_state.bilancio_analysis_done:
        ...
        st.markdown("---")
        st.markdown(
            '<div class="aida-eyebrow">Conversation</div>'
            '<div class="aida-sec-title">Chat with the AI Analyst</div>',
            unsafe_allow_html=True
        )
        ...
        if st.session_state.history:
            for turn in st.session_state.history:
                st.markdown(
                    f'<div class="aida-bubble user"><span class="lbl">Operator</span>{turn["question"]}</div>',
                    unsafe_allow_html=True
                )
                st.markdown(
                    f'<div class="aida-bubble ai"><span class="lbl">AI Analyst</span>{turn["answer"]}</div>',
                    unsafe_allow_html=True
                )
