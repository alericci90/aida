...
# ---------------------------------------------------------------------------
# CHART PALETTE (per coerenza grafici plotly tra light e dark)
#   Usali in sparkline()/radar se vuoi rendere i grafici theme-aware.
# ---------------------------------------------------------------------------
...
def chart_colors(dark: bool = False):
    """Ritorna il set di colori grafici per il tema scelto."""
